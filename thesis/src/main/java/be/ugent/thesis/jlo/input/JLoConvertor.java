...
import be.ugent.thesis.jlo.input.JLoParser.AbstractImplementationContext;
import be.ugent.thesis.jlo.input.JLoParser.AbstractModifierContext;
import be.ugent.thesis.jlo.input.JLoParser.AndExpressionContext;
import be.ugent.thesis.jlo.input.JLoParser.ArgumentsContext;
import be.ugent.thesis.jlo.input.JLoParser.AssignmentStatementContext;
import be.ugent.thesis.jlo.input.JLoParser.BlockContext;
import be.ugent.thesis.jlo.input.JLoParser.BlockImplementationContext;
import be.ugent.thesis.jlo.input.JLoParser.CharacterLiteralContext;
import be.ugent.thesis.jlo.input.JLoParser.ClassBodyContext;
import be.ugent.thesis.jlo.input.JLoParser.CompilationUnitContext;
import be.ugent.thesis.jlo.input.JLoParser.EqualityExpressionContext;
import be.ugent.thesis.jlo.input.JLoParser.EqualityTypeArgumentContext;
import be.ugent.thesis.jlo.input.JLoParser.EqualityTypeConstraintContext;
import be.ugent.thesis.jlo.input.JLoParser.ExponentiationExpressionContext;
import be.ugent.thesis.jlo.input.JLoParser.ExprImplementationContext;
import be.ugent.thesis.jlo.input.JLoParser.ExpressionContext;
import be.ugent.thesis.jlo.input.JLoParser.ExpressionStatementContext;
import be.ugent.thesis.jlo.input.JLoParser.FalseLiteralContext;
import be.ugent.thesis.jlo.input.JLoParser.FloatingPointLiteralContext;
import be.ugent.thesis.jlo.input.JLoParser.HighPriorityNumbericalExpressionContext;
import be.ugent.thesis.jlo.input.JLoParser.IdentifierExpressionContext;
import be.ugent.thesis.jlo.input.JLoParser.ImplementationContext;
import be.ugent.thesis.jlo.input.JLoParser.ImportDeclarationContext;
import be.ugent.thesis.jlo.input.JLoParser.InheritanceRelationContext;
import be.ugent.thesis.jlo.input.JLoParser.InitModifierContext;
import be.ugent.thesis.jlo.input.JLoParser.IntegerLiteralContext;
import be.ugent.thesis.jlo.input.JLoParser.IntegerNumberLiteralContext;
import be.ugent.thesis.jlo.input.JLoParser.KeywordBlockContext;
import be.ugent.thesis.jlo.input.JLoParser.KeywordTypeContext;
import be.ugent.thesis.jlo.input.JLoParser.KlassContext;
import be.ugent.thesis.jlo.input.JLoParser.LiteralExpressionContext;
import be.ugent.thesis.jlo.input.JLoParser.LowPriorityNumbericalExpressionContext;
import be.ugent.thesis.jlo.input.JLoParser.MemberFieldContext;
import be.ugent.thesis.jlo.input.JLoParser.MemberTypeContext;
import be.ugent.thesis.jlo.input.JLoParser.MethodContext;
import be.ugent.thesis.jlo.input.JLoParser.MethodHeaderContext;
import be.ugent.thesis.jlo.input.JLoParser.ModifierContext;
import be.ugent.thesis.jlo.input.JLoParser.NamespaceContext;
import be.ugent.thesis.jlo.input.JLoParser.NamespaceReferenceContext;
import be.ugent.thesis.jlo.input.JLoParser.NativeImplementationContext;
import be.ugent.thesis.jlo.input.JLoParser.NullExpressionContext;
import be.ugent.thesis.jlo.input.JLoParser.OrExpressionContext;
import be.ugent.thesis.jlo.input.JLoParser.OrderExpressionContext;
import be.ugent.thesis.jlo.input.JLoParser.ParExpressionContext;
import be.ugent.thesis.jlo.input.JLoParser.ParameterContext;
import be.ugent.thesis.jlo.input.JLoParser.ParameterListContext;
import be.ugent.thesis.jlo.input.JLoParser.ParametersContext;
import be.ugent.thesis.jlo.input.JLoParser.ParenthesisTypeContext;
import be.ugent.thesis.jlo.input.JLoParser.QualifiedCallExpressionContext;
import be.ugent.thesis.jlo.input.JLoParser.QualifiedTypeContext;
import be.ugent.thesis.jlo.input.JLoParser.ReturnStatementContext;
import be.ugent.thesis.jlo.input.JLoParser.ReturnTypeContext;
import be.ugent.thesis.jlo.input.JLoParser.SelfCallExpressionContext;
import be.ugent.thesis.jlo.input.JLoParser.SelfExpressionContext;
import be.ugent.thesis.jlo.input.JLoParser.ShiftExpressionContext;
import be.ugent.thesis.jlo.input.JLoParser.StatementContext;
import be.ugent.thesis.jlo.input.JLoParser.StringLiteralContext;
import be.ugent.thesis.jlo.input.JLoParser.SubobjectContext;
import be.ugent.thesis.jlo.input.JLoParser.SubtypeArgumentContext;
import be.ugent.thesis.jlo.input.JLoParser.SubtypeConstraintContext;
import be.ugent.thesis.jlo.input.JLoParser.SuperExpressionContext;
import be.ugent.thesis.jlo.input.JLoParser.SuperTypeArgumentContext;
import be.ugent.thesis.jlo.input.JLoParser.SuperTypeConstraintContext;
import be.ugent.thesis.jlo.input.JLoParser.TrueLiteralContext;
import be.ugent.thesis.jlo.input.JLoParser.TypeContext;
import be.ugent.thesis.jlo.input.JLoParser.VarDeclarationContext;
import be.ugent.thesis.jlo.model.component.Subobject;
import be.ugent.thesis.jlo.model.language.JLo;
import be.ugent.thesis.jlo.model.type.KeywordTypeArgument;
import be.ugent.thesis.jlo.model.type.KeywordTypeReference;
import be.ugent.thesis.jlo.model.type.TypeMemberDeclarator;
